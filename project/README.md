...
- **Краткое описание (2-4 предложения):**  
  ...
  > В качестве данных открытый датасет FER‑2013 (изображения лиц 48×48 с метками эмоций). Метрика успеха Accuracy. Какие модели планируется использовать: Логистическая регрессия, RandomForest, CNN/ResNet
...
- Python `>= 3.10` (уточните при необходимости). - Python 3.10.12
